...
class ProductShopMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./ProductShop.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./ProductShop.policy').acl);
  }


  async default (req, res, next) {

    console.log('ProductShop middleware;')
...
module.exports = ProductShopMiddleware;