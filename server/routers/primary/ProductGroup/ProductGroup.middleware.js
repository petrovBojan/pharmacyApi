...
class ProductGroupMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./ProductGroup.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./ProductGroup.policy').acl);
  }


  async default (req, res, next) {

    console.log('ProductGroup middleware;')
...
module.exports = ProductGroupMiddleware;