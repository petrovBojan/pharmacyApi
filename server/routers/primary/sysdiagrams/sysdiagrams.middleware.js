...
class SysdiagramsMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./sysdiagrams.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./sysdiagrams.policy').acl);
  }


  async default (req, res, next) {

    console.log('Sysdiagrams middleware;')
...
module.exports = SysdiagramsMiddleware;