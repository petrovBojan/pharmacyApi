...
class ShopsMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./Shops.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./Shops.policy').acl);
  }


  async default (req, res, next) {

    console.log('Shops middleware;')
...
module.exports = ShopsMiddleware;